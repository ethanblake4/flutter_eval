  ...
  static const $declaration = BridgeClassDef(
        ...
        '': BridgeConstructorDef(BridgeFunctionDef(
            ...
            namedParams: [
              ...
              BridgeParameter(
                  ...
                  true),
              BridgeParameter('fontStyle',
                  BridgeTypeAnnotation($FontStyle.$type, nullable: true), true),
              BridgeParameter(
                  'letterSpacing',
                  BridgeTypeAnnotation(
                      BridgeTypeRef.type(RuntimeTypes.doubleType),
      ...
      getters: {
        ...
        'fontWeight': BridgeMethodDef(BridgeFunctionDef(
            returns: BridgeTypeAnnotation($FontWeight.$type), namedParams: [])),
        'fontStyle': BridgeMethodDef(BridgeFunctionDef(
            returns: BridgeTypeAnnotation($FontStyle.$type), namedParams: [])),
